...
const Courses = () => {
  ...
  return (
    <>
      ...
      <div className="col-md-8 col-sm-5 col-5">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-12">
              <div className="dc">
                <div className="box1" onClick={() => handleClick(<Van />)}>
                  ...
                  <div className="Courses-button-component">
...
const Van = () => {
  return (
    <div className="dev">
      ...
      <p>
        Web design is the process of planning, conceptualizing, and implementing
        a website's layout, content, and appearance to make it functional and
        user-friendly.
      </p>
      ...
      <p>
        On average, web designing course duration varies between 2 months to 6
        months.{" "}
      </p>
      ...
      <ul>
        ...
        <li>
          User research: User interviews, observations, and demographic studies{" "}
        </li>
      </ul>
      ...
      <p>
        <AddIcCallIcon className="icon" /> <WhatsAppIcon className="icon" />{" "}
        <EmailIcon className="icon" />
      </p>

      <img
        src="/img/100-job-assistance-digital-marketing-program.webp"
        alt=""
      />
    </div>
  );
...
const Wd = () => {
  return (
    <div className="dev">
      ...
      <p>
        Some say that beginners can learn the basics of HTML, CSS, and
        JavaScript in 6–12 months, while others say you can learn website
        development skills from scratch in 5–6 months.{" "}
      </p>
...
const Gd = () => {
  return (
    <div className="dev">
      ...
      <p>
        Certificate programs: Some programs offer certificate programs that can
        be completed in 16 weeks or 6 months.
      </p>
...
const Excel = () => {
  return (
    <div className="dev">
      ...
      <p>
        Advanced Excel skills include the ability to produce graphs and tables,
        use spreadsheets efficiently, and perform calculations and automation to
      ...
      <p>
        Overview. Aptech's Advanced Excel is a 1 month course offered at the
        Certificate level.
      </p>
...
const Pally = () => {
  return (
    <div className="dev">
      ...
      <p>
        Tally Solutions is an Indian multinational technology company that
      ...
      <p>
        Generally, the duration of a Tally course is 1 – 3 months, but it varies
        depending on the tally institution you want to join.
      </p>
      ...
      <ul>
        ...
        <li>
          Taxes: Learn about Goods and Services Tax (GST) and Value Added Tax
          (VAT).
        </li>
        <li>
          Payroll: Process payroll, calculate employee benefits, and manage
          company payroll.
        </li>
...
const Com = () => {
  return (
    <div className="dev">
      ...
      <p>
        What is a standard mobile app development timeline? On average, it will
        take 2-4 months to develop a simple mobile app like a plain to-do list
        app, 4-7 months to develop a medium-complexity app like a fitness
        tracker, and 7-12+ months – a complex app like a social media platform
      ...
      <ul>
        <li>
          programming languages,JavaScript, C++, Python, C#, Java, Kotlin,
          React.js, Swift,{" "}
        </li>
...
const Science = () => {
  return (
    <div className="dev">
      ...
      <p>
        Data science is a multidisciplinary field that combines principles from
        mathematics, statistics, artificial intelligence, and computer
        engineering to analyze large amounts of data to extract insights for
        business.{" "}
      </p>
      ...
      <p>
        Data Science is a full-time course of 3-years duration. The course
        comprises of study of domains of Artificial Intelligence, Business
      ...
      <ul>
        ...
        <li>
          Cloud computing , Data mining, Big data, Statistics, Natural language
          processing,
        </li>
      </ul>
      <br />
...
const Analytics = () => {
  return (
    <div className="dev">
      ...
      <p>
        Data analytics is the process of examining raw data to find patterns,
      ...
      <p>
        Diploma or postgraduate diploma: Depending on the institute, these
        courses can take 8 months to 1 year.
      </p>
  ...
  return (
    <div className="dev">
      ...
      <p>
        ...
        AI to imitate the way that humans learn, gradually improving its
        accuracy.
      </p>
      ...
      <p>
        The average machine learning curriculum runs around 6 months, although
        it can take years to master multiple requirements for a specific role.
      </p>
      ...
      <ul>
        ...
        <li>
          Artificial intelligence , Data mining, Computer cluster , Computer
          vision , Classification , Decision trees.
        </li>
      </ul>
      <br />
      <br />
...
const Vfx = () => {
  return (
    <div className="dev">
      ...
      <p>
        A career in Visual Effects (VFX) is one of the most sought-after careers
        in today's time. It has introduced us to the wonders of the
        larger-than-life visual effects (onscreen) that bring the fantasy world
        alive. MAAC understands the true potential of VFX. And therefore, it has
        introduced some exclusive courses on VFX
      </p>
      ...
      <p>
        Visual effects (VFX) courses can range in duration from 6 months to 4
        years, depending on the level of the course.{" "}
      </p>
      ...
      <ul>
        <li>
          Animation and VFX Principles, Lighting and Rendering, Tools and
          Techniques of Cinematography,{" "}
        </li>

        <li>Mass Media and Media Literacy,</li>
        <li>Animation Drawing,</li>

        <li>
          Augmented Reality and Virtual Reality, Story Design and Development,
          Advanced Rigging,{" "}
        </li>
      </ul>
      <br />
...
const Video = () => {
  return (
    <div className="dev">
      ...
      <p>
        {" "}
        Video editing is the art of manipulating and combining video files to
        create a completed video project. Video Editors will cut together film
        clips, alter and correct sound mixing, add digital effects, and make
        other essential technical changes to video files.
      </p>
      <div id="info">
        <h4>Duration :</h4>
      </div>
      <p>
        Diploma programs: These long-term courses can last 6–18 months and cover
        fundamentals like graphic design, photo editing, and non-linear video
        editing.
      </p>
      <div id="info">
        <h4>Topics :</h4>
      ...
      <ul>
        <li>
          Video editing fundamentals , Adobe Premiere Pro , Final Cut Pro{" "}
        </li>
...
const Digital = () => {
  return (
    <div className="dev">
      ...
      <p>
        Specialist courses: These courses can be eight to 12 months long and are
        designed for people who want to become digital marketing specialists.
      </p>
      ...
      <ul>
        ...
        <li>
          Content marketing, Google AdWords, Digital marketing framework ,
